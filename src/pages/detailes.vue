      ...
      <section class="reply-list">
        ...
        <ul>
          <li v-for="(item,index) in topic.replies" :key="index" class="topic-list">
            ...
            <nv-reply :topic.sync="topic" :topic-id="topicId" :reply-id="item.id" :reply-to="item.author.loginname" :show.sync="curReplyId" @replies="newsreplies" v-if="userInfo.id && curReplyId === item.id"></nv-reply>
          </li>
        </ul>
      </section>
    </div>
